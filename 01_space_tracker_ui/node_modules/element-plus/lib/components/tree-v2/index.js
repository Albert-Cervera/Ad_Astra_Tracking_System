...
const treeProps = {
  data: props.buildProp({
    type: props.definePropType(Array),
    default: () => props.mutable([])
  }),
  emptyText: props.buildProp({
    type: String
  }),
  height: props.buildProp({
    type: Number,
    default: 200
  }),
  props: props.buildProp({
  ...
  highlightCurrent: props.buildProp({
    type: Boolean,
    default: false
  }),
  showCheckbox: props.buildProp({
    type: Boolean,
    default: false
  }),
  defaultCheckedKeys: props.buildProp({
    type: props.definePropType(Array),
    default: () => props.mutable([])
  }),
  checkStrictly: props.buildProp({
    type: Boolean,
    default: false
  }),
  defaultExpandedKeys: props.buildProp({
    type: props.definePropType(Array),
    default: () => props.mutable([])
  }),
  indent: props.buildProp({
    type: Number,
    default: 16
  }),
  icon: props.buildProp({
    type: String
  }),
  expandOnClickNode: props.buildProp({
    type: Boolean,
    default: true
  }),
  checkOnClickNode: props.buildProp({
    type: Boolean,
    default: false
  }),
  currentNodeKey: props.buildProp({
    type: props.definePropType([String, Number])
  }),
  accordion: props.buildProp({
    type: Boolean,
    default: false
  }),
  filterMethod: props.buildProp({
    type: props.definePropType(Function)
  }),
  perfMode: props.buildProp({
    type: Boolean,
    default: true
  })
};
const treeNodeProps = {
  node: props.buildProp({
    type: props.definePropType(Object),
    default: () => props.mutable(EMPTY_NODE)
  }),
  expanded: props.buildProp({
    type: Boolean,
    default: false
  }),
  checked: props.buildProp({
    type: Boolean,
    default: false
  }),
  indeterminate: props.buildProp({
    type: Boolean,
    default: false
  }),
  showCheckbox: props.buildProp({
  ...
  disabled: props.buildProp({
    type: Boolean,
    default: false
  }),
  current: props.buildProp({
    type: Boolean,
    default: false
  }),
  hiddenExpandIcon: props.buildProp({
    type: Boolean,
    default: false
  })
};
...
script$2.__file = "packages/components/CaretRight.vue";

var CaretRight = script$2;
