...
const subMenuProps = {
  ...
  showTimeout: props.buildProp({
    type: Number,
    default: 300
  }),
  hideTimeout: props.buildProp({
    type: Number,
    default: 300
  }),
  popperClass: String,
  disabled: Boolean,
  popperAppendToBody: props.buildProp({
    type: Boolean,
    default: void 0
  })
};
...
const menuProps = {
  mode: props.buildProp({
    type: String,
    values: ["horizontal", "vertical"],
    default: "vertical"
  }),
  defaultActive: props.buildProp({
    type: String,
    default: ""
  }),
  defaultOpeneds: props.buildProp({
    type: props.definePropType(Array),
    default: () => props.mutable([])
  }),
  uniqueOpened: Boolean,
  router: Boolean,
  menuTrigger: props.buildProp({
    type: String,
    values: ["hover", "click"],
    default: "hover"
  }),
  ...
  collapseTransition: props.buildProp({
    type: Boolean,
    default: true
  })
};
