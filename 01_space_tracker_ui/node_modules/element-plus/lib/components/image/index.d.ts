...
declare const _Image: SFCWithInstall<import("vue").DefineComponent<{
    ...
    clickHandler: () => void;
    closeViewer: () => void;
    switchViewer: (val: any) => void;
    container: import("vue").Ref<HTMLElement>;
    handleError: (e: Event) => void;
    t: (...args: any[]) => string;
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, ("close" | "error" | "switch")[], "close" | "error" | "switch", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<{
    ...
    scrollContainer?: string | Record<string, any>;
}> & {
